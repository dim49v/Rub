 ...
 */
class Csl {
    //класс точек видимых ячеек кубика
    ...
    void Csl_c(int l, int k) {
        ...
        point[1].set((int) ((double) 620 / l * k), (int) ((double) 100 / l * k));
        point[2].set((int) ((double) 780 / l * k), (int) ((double) 160 / l * k));
        point[3].set((int) ((double) 330 / l * k), (int) ((double) 95 / l * k));
        point[4].set((int) ((double) 475 / l * k), (int) ((double) 155 / l * k));
        point[5].set((int) ((double) 645 / l * k), (int) ((double) 215 / l * k));
        point[6].set((int) ((double) 155 / l * k), (int) ((double) 145 / l * k));
        point[7].set((int) ((double) 305 / l * k), (int) ((double) 215 / l * k));
        ...
        point[19].set((int) ((double) 720 / l * k), (int) ((double) 350 / l * k));
        point[20].set((int) ((double) 850 / l * k), (int) ((double) 280 / l * k));
        point[21].set((int) ((double) 555 / l * k), (int) ((double) 625 / l * k));
        point[22].set((int) ((double) 700 / l * k), (int) ((double) 545 / l * k));
        point[23].set((int) ((double) 840 / l * k), (int) ((double) 470 / l * k));
        point[24].set((int) ((double) 555 / l * k), (int) ((double) 805 / l * k));
        point[25].set((int) ((double) 695 / l * k), (int) ((double) 720 / l * k));
        point[26].set((int) ((double) 820 / l * k), (int) ((double) 645 / l * k));

        rad[0] = (int)((double)50/l*k);
        rad[1] = (int)((double)55/l*k);
        rad[2] = (int)((double)65/l*k);
        rad[3] = (int)((double)60/l*k);
        rad[4] = (int)((double)55/l*k);
        rad[5] = (int)((double)60/l*k);
        rad[6] = (int)((double)70/l*k);
        rad[7] = (int)((double)60/l*k);
        rad[8] = (int)((double)60/l*k);

        rad[9] = (int)((double)65/l*k);
        rad[10] = (int)((double)70/l*k);
        rad[11] = (int)((double)80/l*k);
        rad[12] = (int)((double)65/l*k);
        rad[13] = (int)((double)70/l*k);
        rad[14] = (int)((double)78/l*k);
        rad[15] = (int)((double)65/l*k);
        rad[16] = (int)((double)65/l*k);
        rad[17] = (int)((double)70/l*k);

        rad[18] = (int)((double)80/l*k);
        rad[19] = (int)((double)70/l*k);
        rad[20] = (int)((double)65/l*k);
        rad[21] = (int)((double)75/l*k);
        rad[22] = (int)((double)70/l*k);
        rad[23] = (int)((double)70/l*k);
        rad[24] = (int)((double)70/l*k);
        rad[25] = (int)((double)70/l*k);
        rad[26] = (int)((double)65/l*k);
    }
